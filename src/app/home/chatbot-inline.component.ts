...
@Component({ 
    selector: 'app-chatbot-inline',
    templateUrl: './chatbot-inline.component.html',
    styleUrls: ['./chatbot-inline.component.less']
})
export class ChatbotInlineComponent implements OnInit, AfterViewChecked {
